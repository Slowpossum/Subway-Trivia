    ...
    11: {
        ...
        doAfter: function () {
            if (this.answer === 1) {
                ...
                script[13].text = `Right? It's great seeing them go back to that brutal, unrestrained edge that they had before, 
it's like a warm hug from an old friend. A friend covered in razor blades and nails.`;
            }
        }
    },
    12: {
    ...
    16: {
        ...
        text: `Anyway, here's another: Born in 1450, this Dutch painter is one of the most notable painters of the Early Netherlandish Renaissance movement.
His paintings- and primarily his triptychs- are characterized by their gruesome and fantastic depictions of heaven, hell, and earth. Who is the painter?`,
        doAfter: function () {
            switch (this.answer) {
                case 1:
                ...
                case 3:
                    ...
                    script[18].text = `Nope, it was Van Gogh. Crazy guy, cutting his ear off and drawing heaven and hell. Artists are so weird, bro.
If you ask me we should just worry about the earth are feet are on, y'know?`;
                    break;
                case 4:
